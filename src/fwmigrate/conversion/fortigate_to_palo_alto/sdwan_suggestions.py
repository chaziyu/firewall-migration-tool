...
from .recommendations import PANMigrationRecommendation, PANRecommendationConfidence, PANRecommendationMethod, decision_key_if_present, recommendation_key, source_facts, target_names
...
def build_sdwan_recommendations(source, derived, decisions, target=None, target_device=None):
    ...
    for sdwan in getattr(source, "sdwans", ()):
        ...
        for member in sdwan.members:
            ...
            blockers = ("Target interface mapping required",) if member.interface and not key else ()

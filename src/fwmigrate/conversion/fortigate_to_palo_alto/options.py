...
class PANMigrationOptions:
    ...
    interfaces: Mapping[str, InterfaceMapping | Mapping[str, str | None]] = field(default_factory=dict)

    def __post_init__(self) -> None:
        object.__setattr__(self, "vdoms", self._coerce(self.vdoms, VDOMMapping))
        object.__setattr__(self, "interfaces", self._coerce(self.interfaces, InterfaceMapping))

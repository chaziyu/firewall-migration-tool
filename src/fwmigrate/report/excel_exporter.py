...
class IRExcelExporter:
    ...
    def _build_interfaces(self, workbook: Any) -> None:
        headers = (
            ...
            "Enabled", "MTU", "Link State", "Speed", "Duplex", "NetFlow Profile",
            "LLDP Enabled", "Interface Type", "Members", "Extraction Status",
        ...
        rows = [
            (
                ...
                item.source_speed, item.source_duplex, item.source_netflow_profile,

    ...
    def _build_local_in_policies(self, workbook: Any) -> None:
        ...
        self._table_sheet(
            ...
            (
                ...
                "Destination Address", "Service", "Schedule", "Protocol",
    ...
    def _build_cisco_pbr(self, workbook: Any) -> None:
        self._table_sheet(
            ...
            (
                ...
                "Ingress Interface", "Next Hop", "Next Hops", "Output Interface", "Output Interfaces", "Enabled", "Migration Status", "Manual Review",
                "Review Reasons", "Additional Settings",
            ),
            (
                (
                    ...
                    item.output_interface, item.output_interfaces,

...
from fwmigrate.vendors.checkpoint.gaia_scoped import GaiaParseResult
from fwmigrate.vendors.checkpoint.gaia_scoped import parse_gaia_configuration as _parse_scoped

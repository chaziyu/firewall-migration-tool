...
from fwmigrate.vendors.checkpoint.authentication import extract_authentication
from fwmigrate.vendors.checkpoint.identity import extract_identity
from fwmigrate.vendors.checkpoint.access import extract_access_rulebase
from fwmigrate.vendors.checkpoint.coverage import (
    authoritative_object_identity,
    create_section_result,
)
from fwmigrate.vendors.checkpoint.gaia_scope_policy import parse_gaia_configuration
from fwmigrate.vendors.checkpoint.finalization import finalize_checkpoint_extraction
from fwmigrate.vendors.checkpoint.cluster import extract_clusters
from fwmigrate.vendors.checkpoint.performance import extract_performance_settings
from fwmigrate.vendors.checkpoint.certificates import attach_certificate_usages, extract_certificates
from fwmigrate.vendors.checkpoint.gateways import extract_gateway_topology, extract_sic_metadata
from fwmigrate.vendors.checkpoint.loader import (
...
from fwmigrate.vendors.checkpoint.source_model import CheckPointConfig
from fwmigrate.vendors.checkpoint.nat import extract_nat_rulebase
from fwmigrate.vendors.checkpoint.ip_pool_nat import extract_ip_pool_nat
from fwmigrate.vendors.checkpoint.dependencies import build_checkpoint_dependencies
from fwmigrate.vendors.checkpoint.objects import extract_address_objects, extract_application_objects
from fwmigrate.vendors.checkpoint.https_inspection import extract_https_inspection_rulebase
from fwmigrate.vendors.checkpoint.resolver import (
    CheckPointObjectResolver,
    SemanticKind,
    infer_semantic_kind,
    iter_dictionary_objects,
)
from fwmigrate.vendors.checkpoint.rulebase import flatten_rulebase
from fwmigrate.vendors.checkpoint.schedules import extract_time_objects
from fwmigrate.vendors.checkpoint.services import extract_service_objects
from fwmigrate.vendors.checkpoint.threat_prevention import extract_threat_prevention
from fwmigrate.vendors.checkpoint.threat_profiles import extract_threat_profiles
from fwmigrate.vendors.checkpoint.vpn import extract_vpn
...
class CheckPointIRAdapter:
    """Legacy migration adapter from CheckPointConfig to canonical IR."""
    ...
    def to_extraction_result(self) -> ExtractionResult:
        # The existing staged IR logic remains the compatibility implementation;
        # the source aggregate is now the explicit input boundary for this adapter.
        return _extract_checkpoint_ir(self.bundle, self.scope, self.zone_mapping)

...
_COMMAND_DISPATCH: dict[str, Dispatch] = {
    ...
    "show-multicast-address-ranges": (CPAddressRange, "address_ranges", None),
    "show-dns-domains": (CPDNSDomain, "dns_domains", frozenset({"dns", "dns-domain", "domain-name", "domain"})),
    "show-wildcards": (CPWildcardAddress, "wildcard_addresses", None),
    ...
    "show-services-sctp": (CPService, "services", None),
    "show-services-icmp": (CPService, "services", frozenset({"service-icmp"})),
    "show-services-icmp6": (CPService, "services", None),
    "show-services-citrix-tcp": (CPService, "services", None),
    "show-services-dce-rpc": (CPService, "services", None),
    "show-services-rpc": (CPService, "services", None),
    "show-services-gtp": (CPService, "services", None),
    "show-services-compound-tcp": (CPService, "services", None),
    ...
    "show-application-sites": (CPApplication, "applications", None),
    "show-application-site-groups": (CPApplication, "applications", None),
    "show-application-site-categories": (CPApplication, "applications", None),
    ...
    "show-vpn-communities-star": (CPVPNCommunity, "vpn_communities", None),
    "show-vpn-communities-meshed": (CPVPNCommunity, "vpn_communities", None),
    "show-vpn-communities-remote-access": (CPVPNCommunity, "vpn_communities", None),

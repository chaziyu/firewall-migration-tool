...
from fwmigrate.vendors.cisco_asa.model import CiscoManagementSetting
from fwmigrate.vendors.cisco_asa.model_phase10_17 import CiscoConnectionControlPhase11
...
def _wrap_class_map_block(original: Any):
    ...
    def parse(self: Any, lines: List[str], index: int):
        ...
        import fwmigrate.vendors.cisco_asa.phase10_17 as phase

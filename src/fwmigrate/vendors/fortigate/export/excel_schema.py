...
SHEET_ORDER: tuple[str, ...] = (
    ...
    "System Settings", "DNS Settings", "NTP Settings", "NTP Servers", "Session Helpers", "Router Settings", "IPS Settings",
    "Interfaces", "Interface Secondary IPs", "Zones",
    "Addresses", "Wildcard FQDN", "Address Groups", "Service Categories", "Services", "Service Groups", "Schedules", "Schedule Groups",
    "Policies", "Security Policies", "Protocol Options", "Per-IP Shapers", "NAT Rules", "IP Pools", "Virtual IPs", "VIP Real Servers", "VIP Groups",
    ...
    "SSL VPN Settings", "SSL VPN Realms", "SSL VPN Clients", "SSL VPN Bookmark Owners", "SSL VPN Bookmarks", "SSL VPN Portals", "SSL VPN Authentication Rules", "SSL VPN Host Checks", "SSL VPN Host Check Items",
    "Local Users", "User Groups", "User Group Matches", "User Group Guests", "NAC Policies", "Kerberos Keytabs",
    "Administrators", "Admin Profiles", "Admin Profile Permissions",
    "IPS Sensors", "IPS Sensor Entries", "IPS Exempt IPs", "Security Profiles",
    "External Resources", "KMIP Servers", "SDN Proxies", "IPv6 Address Templates", "On-Demand Sniffers", "Affinity Interrupts", "Serial Ports", "Firewall Regions", "Vendor MACs", "Unresolved References", "Unsupported", "FortiGate Source Inventory",
    "Extraction Coverage",
)
...
SHEET_HEADERS: dict[str, tuple[str, ...]] = {
    ...
    "Session Helpers": ("ID", "Name", "Port", "Protocol", "VDOM", "Analysis Status", "Review Reasons", "Additional Settings"),
    "Router Settings": ("Hostname", "Show Filter", "VDOM", "Analysis Status", "Review Reasons", "Additional Settings"),
    "IPS Settings": ("IPS Packet Quota", "Packet Log History", "VDOM", "Analysis Status", "Review Reasons", "Additional Settings"),
    "NAC Policies": ("Name", "Category", "Description", "MAC", "Host", "OS", "Family", "Hardware Vendor", "Hardware Version", "Severity", "Firewall Address", "User Group", "Status", "VDOM", "Analysis Status", "Review Reasons", "Additional Settings"),
    "Kerberos Keytabs": ("Name", "Principal", "LDAP Servers", "PAC Data", "Keytab Configured", "VDOM", "Analysis Status", "Review Reasons", "Additional Settings"),
    "KMIP Servers": ("Name", "Interface", "Interface Selection", "Password Configured", "Server Identity Check", "Username", "Source IP", "Minimum TLS Protocol", "Server List", "VDOM", "Analysis Status", "Review Reasons", "Additional Settings"),
    "SDN Proxies": ("Name", "Server", "Server Port", "Type", "Username", "Password Configured", "VDOM", "Analysis Status", "Review Reasons", "Additional Settings"),
    "IPv6 Address Templates": ("Name", "IPv6 Prefix", "Fabric Object", "Segment Count", "Segments", "VDOM", "Analysis Status", "Review Reasons", "Additional Settings"),
    "On-Demand Sniffers": ("Name", "Advanced Filter", "Hosts", "Interface", "Maximum Packet Count", "Include Non-IP Packets", "Ports", "Protocols", "VDOM", "Analysis Status", "Review Reasons", "Additional Settings"),
    "Affinity Interrupts": ("ID", "Interrupt", "CPU Mask", "Default CPU Mask", "Analysis Status", "Review Reasons", "Additional Settings"),
    "Serial Ports": ("Name", "Read Only", "Analysis Status", "Review Reasons", "Additional Settings"),
    "Firewall Regions": ("ID", "Name", "Cities", "Read Only", "Analysis Status", "Review Reasons", "Additional Settings"),
    "Vendor MACs": ("ID", "Name", "MAC Count", "Obsolete", "Read Only", "Analysis Status", "Review Reasons", "Additional Settings"),
    "Interfaces": (
    ...
    "Service Categories": ("Name", "Description", "VDOM", "Analysis Status", "Review Reasons", "Source Explicit Fields", "Additional Settings"),
    ...
    "Protocol Options": ("Name", "Comment", "VDOM", "Analysis Status", "Review Reasons", "Source Explicit Fields", "Additional Settings"),
    "Per-IP Shapers": ("Name", "Maximum Bandwidth", "Bandwidth Unit", "Maximum Sessions", "Maximum TCP Sessions", "Maximum UDP Sessions", "DiffServ Forward", "DiffServ Reverse", "Forward DiffServ Code", "Reverse DiffServ Code", "VDOM", "Analysis Status", "Review Reasons", "Additional Settings"),
    ...
    "SSL VPN Host Checks": ("Name", "Type", "OS Type", "Version", "GUID", "Check Item Count", "VDOM", "Analysis Status", "Review Reasons", "Source Explicit Fields", "Additional Settings"),
    "SSL VPN Host Check Items": ("Host Check", "ID", "Action", "Type", "Target", "MD5s", "Version", "VDOM", "Analysis Status", "Review Reasons", "Source Explicit Fields", "Additional Settings"),

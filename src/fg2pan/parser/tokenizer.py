    ...
    def tokenize(self) -> Iterator[Token]:
        ...
        for line_number, line in enumerate(self.text.splitlines(), start=1):
            ...
            try:
                ...
                # in a well-formed FortiGate config, this might be an error.
                # However, some lines might just be values if they wrapped (rare in clean configs).
                # For our purposes, we'll treat the whole line as string tokens.
                for part in parts:
                    yield Token(TokenType.STRING, part, line_number)

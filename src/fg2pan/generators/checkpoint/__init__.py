...
from fg2pan.generators.checkpoint.cli_generator import CheckPointCLIGenerator
from fg2pan.generators.checkpoint.terraform_generator import CheckPointTerraformGenerator

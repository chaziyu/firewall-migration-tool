...
- **Generated At:** 2026-08-20 02:41:22 UTC
...
| :--- | :--- | :--- | :--- | :--- |
| `port1` | Physical | `trust` | `192.168.1.99/24` | - |
| `port2` | Physical | `untrust` | `203.0.113.2/24` | - |
| `port3` | Physical | `dmz` | `10.1.1.1/24` | - |
...
```json
{
  "metadata": {
    ...
    "target_vendor": null,
    "migration_timestamp": "2026-08-20T02:41:22.888740Z"
  },
  "zones": [
    {
      "name": "trust",

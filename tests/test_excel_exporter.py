...
def test_excel_exporter_exposes_source_policy_audit_fields():
    ...
    assert [cell.value for cell in policies[3]] == [
        ...
        "Web Filter", "Application List", "SSL/SSH Profile", "Source Profile Type",
            ...
            "Security Profile Semantics Review", "URL Categories", "Security Profile Groups",
            "Antivirus Profiles", "Vulnerability Profiles", "Antispyware Profiles",
            "URL Filtering Profiles", "File Blocking Profiles", "Wildfire Analysis Profiles",
            "Data Filtering Profiles", "Unresolved Source Zones", "Unresolved Destination Zones",
            "Inspection Mode",

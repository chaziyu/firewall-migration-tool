...
"""
    ...
    assert {(d.source_path, d.source_field, d.reference, d.expected_type, d.result)
            for d in certificate_dependencies} == {
        ("system global", "admin-server-cert", "LOCAL", "vpn certificate local", "RESOLVED"),
        ("user setting", "auth-cert", "LOCAL", "vpn certificate local", "RESOLVED"),
        ("user setting", "auth-ca-cert", "CA", "vpn certificate ca", "RESOLVED"),
        ("user ldap", "ca-cert", "CA", "vpn certificate ca", "RESOLVED"),
        ("user peer", "ca", "CA", "vpn certificate ca", "RESOLVED"),
        ("user saml", "cert", "LOCAL", "vpn certificate local", "RESOLVED"),
        ("user saml", "idp-cert", "REMOTE", "vpn certificate remote", "RESOLVED"),
        ("system saml", "cert", "LOCAL", "vpn certificate local", "RESOLVED"),
        ("system saml", "idp-cert", "REMOTE", "vpn certificate remote", "RESOLVED"),
        ("vpn ssl settings", "servercert", "LOCAL", "vpn certificate local", "RESOLVED"),
        ("firewall vip", "ssl-certificate", "LOCAL", "vpn certificate local", "RESOLVED"),
        ("firewall access-proxy", "certificate", "LOCAL", "vpn certificate local", "RESOLVED"),
        ("firewall access-proxy", "ssl-certificate", "LOCAL", "vpn certificate local", "RESOLVED"),
        ("firewall access-proxy-virtual-host", "ssl-certificate", "LOCAL", "vpn certificate local", "RESOLVED"),
        ("firewall ssl-ssh-profile", "caname", "CA", "vpn certificate ca", "RESOLVED"),
        ("firewall ssl-ssh-profile", "server-cert", "LOCAL", "vpn certificate local", "RESOLVED"),
    }
